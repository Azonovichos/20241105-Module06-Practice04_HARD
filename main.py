# Module 6 Practice HARD

import math  #для использования более точного числа пи, для расчёта площади круга
...
class Figure:
    ...
    def __init__(self, color, *sides):
        ...
        self.__color = self.__correct_color(color)
        self.filled = False

    def get_color(self):
        return self.__color

    # get_color сначала написал через (r, g, b)
    # переписал через (self)
    ...
    def __correct_sides(self, sides):
        if len(sides) != self.sides_count:
            return [1] * self.sides_count
        return list(sides)

    def __correct_color(self, color):
